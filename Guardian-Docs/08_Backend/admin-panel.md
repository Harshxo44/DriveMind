# Guardian - Admin Panel

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Admin Panel** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Admin Panel | Safe, understandable, low-friction |
...
|---|---|---|
| 08-ADMIN-PANEL-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 08-ADMIN-PANEL-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 08-ADMIN-PANEL-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Admin Panel |
