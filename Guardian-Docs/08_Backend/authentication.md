...
|---|---|---|
| 08-AUTHENTICATION-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 08-AUTHENTICATION-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 08-AUTHENTICATION-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
