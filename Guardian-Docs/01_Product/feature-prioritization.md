# Guardian - Feature Prioritization

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Feature Prioritization** so the Guardian team can move from discovery to a safe, testable product decision.

## Scope

This document covers customer desirability, a credible price-to-value proposition, and a deliberately constrained first release. It applies to the India-first MVP for mid-range and older passenger vehicles; it excludes direct vehicle actuation, safety-critical driving control, and unsupported vehicle modifications.
...
|---|---|---|
| Experience | Driver and owner outcome for Feature Prioritization | Safe, understandable, low-friction |
...
|---|---|---|
| 01-FEATURE-PRIORITIZATION-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 01-FEATURE-PRIORITIZATION-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 01-FEATURE-PRIORITIZATION-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |

## Risks and mitigations

- **Primary risk:** Unvalidated customer, technical, regulatory, or operational assumptions may cause rework.
...
- Related foundation: [Master Roadmap](../00_Master_Roadmap/master-roadmap.md) | [Overall Architecture](../03_System_Architecture/overall-architecture.md) | [Threat Model](../13_Security/threat-model.md) | [Integration Testing](../14_Testing/integration-testing.md)
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Feature Prioritization |
