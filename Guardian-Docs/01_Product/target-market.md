# Guardian - Target Market

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Target Market** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Target Market | Safe, understandable, low-friction |
...
|---|---|---|
| 01-TARGET-MARKET-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 01-TARGET-MARKET-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 01-TARGET-MARKET-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Target Market |
