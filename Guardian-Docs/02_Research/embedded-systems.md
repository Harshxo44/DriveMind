# Guardian - Embedded Systems

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Embedded Systems** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Embedded Systems | Safe, understandable, low-friction |
...
|---|---|---|
| 02-EMBEDDED-SYSTEMS-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 02-EMBEDDED-SYSTEMS-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 02-EMBEDDED-SYSTEMS-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Embedded Systems |
