...
Define the decisions, evidence, and acceptance criteria for **Assembly** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Assembly | Safe, understandable, low-friction |
...
|---|---|---|
| 16-ASSEMBLY-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 16-ASSEMBLY-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 16-ASSEMBLY-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Assembly |
