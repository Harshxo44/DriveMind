# Guardian - Certification Checklist

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Certification Checklist** so the Guardian team can move from discovery to a safe, testable product decision.

## Scope

This document covers design-for-manufacture, traceability, quality gates, and controlled supplier hand-offs. It applies to the India-first MVP for mid-range and older passenger vehicles; it excludes direct vehicle actuation, safety-critical driving control, and unsupported vehicle modifications.
...
|---|---|---|
| Experience | Driver and owner outcome for Certification Checklist | Safe, understandable, low-friction |
...
|---|---|---|
| 16-CERTIFICATION-CHECKLIST-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 16-CERTIFICATION-CHECKLIST-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 16-CERTIFICATION-CHECKLIST-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |

## Risks and mitigations

- **Primary risk:** Unit economics, certification, supplier quality, or channel assumptions may delay a viable launch.
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Certification Checklist |
