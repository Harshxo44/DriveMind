# Guardian - Guardian AI Architecture

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Guardian AI Architecture** so the Guardian team can move from discovery to a safe, testable product decision.

## Scope

This document covers useful conversational assistance that stays grounded, private, and non-distracting while driving. It applies to the India-first MVP for mid-range and older passenger vehicles; it excludes direct vehicle actuation, safety-critical driving control, and unsupported vehicle modifications.
...
|---|---|---|
| Experience | Driver and owner outcome for Guardian AI Architecture | Safe, understandable, low-friction |
...
|---|---|---|
| 06-GUARDIAN-AI-ARCHITECTURE-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 06-GUARDIAN-AI-ARCHITECTURE-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 06-GUARDIAN-AI-ARCHITECTURE-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |

## Risks and mitigations

- **Primary risk:** An inaccurate or distracting interaction can reduce trust or create driver-safety risk.
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Guardian AI Architecture |
