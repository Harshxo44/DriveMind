# Guardian - Memory Architecture

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Memory Architecture** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Memory Architecture | Safe, understandable, low-friction |
...
|---|---|---|
| 06-MEMORY-ARCHITECTURE-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 06-MEMORY-ARCHITECTURE-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 06-MEMORY-ARCHITECTURE-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Memory Architecture |
