# Guardian - Speech Pipeline

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Speech Pipeline** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Speech Pipeline | Safe, understandable, low-friction |
...
|---|---|---|
| 06-SPEECH-PIPELINE-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 06-SPEECH-PIPELINE-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 06-SPEECH-PIPELINE-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Speech Pipeline |
