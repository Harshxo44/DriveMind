...
Define the decisions, evidence, and acceptance criteria for **Integration Testing** so the Guardian team can move from discovery to a safe, testable product decision.
...
|---|---|---|
| Experience | Driver and owner outcome for Integration Testing | Safe, understandable, low-friction |
...
|---|---|---|
| 14-INTEGRATION-TESTING-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 14-INTEGRATION-TESTING-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 14-INTEGRATION-TESTING-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Integration Testing |
