# Guardian - Target Manufacturing Cost

> **Status:** Draft foundation | **Owner:** TBD | **Review cadence:** monthly and at each design gate

## Purpose

Define the decisions, evidence, and acceptance criteria for **Target Manufacturing Cost** so the Guardian team can move from discovery to a safe, testable product decision.

## Scope

This document covers automotive electrical robustness, low BOM cost, serviceability, and plug-and-play installation. It applies to the India-first MVP for mid-range and older passenger vehicles; it excludes direct vehicle actuation, safety-critical driving control, and unsupported vehicle modifications.
...
|---|---|---|
| Experience | Driver and owner outcome for Target Manufacturing Cost | Safe, understandable, low-friction |
...
|---|---|---|
| 05-TARGET-MANUFACTURING-COST-01 | Outcome and owner are explicit | Reviewed specification and accountable DRI |
| 05-TARGET-MANUFACTURING-COST-02 | Failure behavior protects the driver and vehicle | Test record, safe-state definition, and support playbook |
| 05-TARGET-MANUFACTURING-COST-03 | Data handling follows consent and retention policy | Privacy/security sign-off and audit trail |

## Risks and mitigations

- **Primary risk:** Electrical transients, vehicle variability, and component availability can invalidate lab assumptions.
...
|---|---|---|---|
| 0.1 | 2026-08-03 | Guardian documentation bootstrap | Initial engineering template tailored to Target Manufacturing Cost |
